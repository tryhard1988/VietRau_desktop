...
public class KhoVatTu_PhieuSX_Trong_Printer
{
    ...
    private void Pd_PrintPage(object sender, PrintPageEventArgs e)
    {
        ...
        while (rowIndex < mPlantingManagement_dt.Rows.Count)
        {
            ...
            // Table Header
            g.DrawRectangle(Pens.Gray, colHeaderX, y, col1Width + col2Width, lineHeight * numRow);
            g.DrawLine(Pens.Gray, colHeaderX + col1Width, y, colHeaderX + col1Width, y + lineHeight * numRow);

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Lệnh Sản Xuất", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, row["ProductionOrder"].ToString(), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Tên Cây Trồng", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, row["PlantName"].ToString(), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Mã Cây Trồng", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, row["SKU"].ToString(), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Diện Tích", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, row["Area"].ToString(), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Ngày Trồng", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, plantingDate.ToString("dd/MM/yyyy"), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;

            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "Ngày Thu Hoạch", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
            DrawCellText(g, Convert.ToDateTime(row["HarvestDate"]).ToString("dd/MM/yyyy"), headerFont, new Rectangle(colHeaderX + col1Width, y, col2Width, lineHeight)); y += lineHeight;


            g.DrawLine(Pens.Gray, colHeaderX, y, colHeaderX + col1Width + col2Width, y);
            DrawCellText(g, "S.Lượng Dự Kiến", headerFont, new Rectangle(colHeaderX, y, col1Width, lineHeight));
