...
public class KhoVatTu_LichUomCay_Printer
{
    ...
    private void Pd_PrintPage(object sender, PrintPageEventArgs e)
    {
        ...
        DrawCellText(g, "Thứ", tableHeaderFont, new Rectangle(col_ThuUom, y, colWidth_Thu, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "Ngày Ươm", tableHeaderFont, new Rectangle(col_NgayUom, y, colWidth_Ngay, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "Lệnh SX", tableHeaderFont, new Rectangle(col_LenhSX, y, colWidth_LenhSX, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "Tên Cây", tableHeaderFont, new Rectangle(col_TenSP, y, colWidth_TenSP, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "S.Lượng", tableHeaderFont, new Rectangle(col_SL, y, colWidth_SL, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "S.Khay", tableHeaderFont, new Rectangle(col_Khay, y, colWidth_khay, tableHeaderLineHeight), StringAlignment.Center);
        ...
        DrawCellText(g, "D.Tích", tableHeaderFont, new Rectangle(col_Area, y, colWidth_area, tableHeaderLineHeight), StringAlignment.Center);
        DrawCellText(g, "Ghi Chú", tableHeaderFont, new Rectangle(col_ghiChu, y, colWidth_ghiChu, tableHeaderLineHeight), StringAlignment.Center);
        ...
        while (rowIndex < mPlantingManagement_dt.Rows.Count)
        {
            ...
            DrawCellText(g, Utils.GetThu_Viet(nurseryDate), normalFont, new Rectangle(col_ThuUom, y, colWidth_Thu, lineHeight), StringAlignment.Center);
            DrawCellText(g, nurseryDate.ToString("dd/MM/yyyy"), normalFont, new Rectangle(col_NgayUom, y, colWidth_Ngay, lineHeight), StringAlignment.Center);
            DrawCellText(g, productionOrder, normalFont, new Rectangle(col_LenhSX, y, colWidth_LenhSX, lineHeight), StringAlignment.Center);
            DrawCellText(g, plantName, normalFont, new Rectangle(col_TenSP, y, colWidth_TenSP, lineHeight), StringAlignment.Center);
            DrawCellText(g, quantity.ToString("N0"), normalFont, new Rectangle(col_SL, y, colWidth_SL, lineHeight), StringAlignment.Center);
            DrawCellText(g, soKhay.ToString("N0"), normalFont, new Rectangle(col_Khay, y, colWidth_khay, lineHeight), StringAlignment.Center);
            DrawCellText(g, plantingDate.ToString("dd/MM/yyyy"), normalFont, new Rectangle(col_NgayTrong, y, colWidth_Ngay, lineHeight), StringAlignment.Center);
            DrawCellText(g, area.ToString("0.##"), normalFont, new Rectangle(col_Area, y, colWidth_area, lineHeight), StringAlignment.Center);
            DrawCellText(g, note, normalFont, new Rectangle(col_ghiChu, y, colWidth_ghiChu, lineHeight), StringAlignment.Center);
