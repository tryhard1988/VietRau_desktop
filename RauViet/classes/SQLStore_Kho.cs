...
namespace RauViet.classes
{
    public sealed class SQLStore_Kho
    {
        ...
        public async Task<DataTable> getDomesticLiquidationImportAsync()
        {
            if (mDomesticLiquidationImport_dt == null)
            {
                try
                {
                    ...
                    await editDomesticLiquidationImport();
                }
                catch
                {
        ...
        {
            if (mDomesticLiquidationExportLog_dt == null)
            {
                DataTable dt = await SQLManager_Kho.Instance.GetDomesticLiquidationExportLogAsync();
